...
protobufs:protoc_gen_swipl_version(plugin_pb,[0,9,2]).
swi_prolog_version('10.1.3-15-g39f600e7d-DIRTY').
protoc_version('7.34.0').
prototoc_gen_swipl_args([]).
protoc_run_time('2026-03-09T00:00:26+0000', '2026-03-08T17:00:26-0700').
...
protobufs:proto_meta_package('.google.protobuf.compiler','google/protobuf/compiler/plugin.proto','.google.protobuf.FileOptions'{cc_enable_arenas:true,cc_generic_services:false,csharp_namespace:"Google.Protobuf.Compiler",deprecated:false,go_package:"google.golang.org/protobuf/types/pluginpb",java_generate_equals_and_hash:false,java_generic_services:false,java_multiple_files:false,java_outer_classname:"PluginProtos",java_package:"com.google.protobuf.compiler",java_string_check_utf8:false,objc_class_prefix:"",optimize_for:"SPEED",php_class_prefix:"",php_generic_services:false,php_metadata_namespace:"",php_namespace:"",py_generic_services:false,ruby_package:"",swift_prefix:"",uninterpreted_option:[]}).
...
protobufs:proto_meta_field_name('.google.protobuf.compiler.CodeGeneratorRequest',17,source_file_descriptors,'.google.protobuf.compiler.CodeGeneratorRequest.source_file_descriptors').
protobufs:proto_meta_field_json_name('.google.protobuf.compiler.CodeGeneratorRequest.source_file_descriptors',sourceFileDescriptors).
protobufs:proto_meta_field_label('.google.protobuf.compiler.CodeGeneratorRequest.source_file_descriptors','LABEL_REPEATED').
protobufs:proto_meta_field_type('.google.protobuf.compiler.CodeGeneratorRequest.source_file_descriptors','TYPE_MESSAGE').
protobufs:proto_meta_field_type_name('.google.protobuf.compiler.CodeGeneratorRequest.source_file_descriptors','.google.protobuf.FileDescriptorProto').
protobufs:proto_meta_field_oneof_index('.google.protobuf.compiler.CodeGeneratorRequest.source_file_descriptors',0).
protobufs:proto_meta_field_default_value('.google.protobuf.compiler.CodeGeneratorRequest.source_file_descriptors',[]).
...
protobufs:proto_meta_field_name('.google.protobuf.compiler.CodeGeneratorResponse',3,minimum_edition,'.google.protobuf.compiler.CodeGeneratorResponse.minimum_edition').
protobufs:proto_meta_field_json_name('.google.protobuf.compiler.CodeGeneratorResponse.minimum_edition',minimumEdition).
protobufs:proto_meta_field_label('.google.protobuf.compiler.CodeGeneratorResponse.minimum_edition','LABEL_OPTIONAL').
protobufs:proto_meta_field_type('.google.protobuf.compiler.CodeGeneratorResponse.minimum_edition','TYPE_INT32').
protobufs:proto_meta_field_type_name('.google.protobuf.compiler.CodeGeneratorResponse.minimum_edition','').
protobufs:proto_meta_field_oneof_index('.google.protobuf.compiler.CodeGeneratorResponse.minimum_edition',0).
protobufs:proto_meta_field_default_value('.google.protobuf.compiler.CodeGeneratorResponse.minimum_edition',0).
protobufs:proto_meta_field_name('.google.protobuf.compiler.CodeGeneratorResponse',4,maximum_edition,'.google.protobuf.compiler.CodeGeneratorResponse.maximum_edition').
protobufs:proto_meta_field_json_name('.google.protobuf.compiler.CodeGeneratorResponse.maximum_edition',maximumEdition).
protobufs:proto_meta_field_label('.google.protobuf.compiler.CodeGeneratorResponse.maximum_edition','LABEL_OPTIONAL').
protobufs:proto_meta_field_type('.google.protobuf.compiler.CodeGeneratorResponse.maximum_edition','TYPE_INT32').
protobufs:proto_meta_field_type_name('.google.protobuf.compiler.CodeGeneratorResponse.maximum_edition','').
protobufs:proto_meta_field_oneof_index('.google.protobuf.compiler.CodeGeneratorResponse.maximum_edition',0).
protobufs:proto_meta_field_default_value('.google.protobuf.compiler.CodeGeneratorResponse.maximum_edition',0).
...
protobufs:proto_meta_enum_value('.google.protobuf.compiler.CodeGeneratorResponse.Feature','FEATURE_SUPPORTS_EDITIONS',2).
